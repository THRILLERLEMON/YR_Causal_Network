...
def main():
    ...
    ax1.set_xlabel('Harvest Factors',
                   fontsize=14,
                   fontfamily='Arial')
    ...
    ax2.set_xlabel('Harvest Factors',
                   fontsize=14,
                   fontfamily='Arial')
    ...
    ax3.set_xlabel('Harvest Factors',
                   fontsize=14,
                   fontfamily='Arial')
    # ax2.set_ylabel('Other vars', fontsize=12, fontfamily='Arial')
    ...
    plt.savefig(OUT_PATH + 'Figures//Show_all_in_one_LinkType_Harvest.pdf')
